...
var WeatherService = (function () {
  ...
  WeatherService.serviceName = "weather.WeatherService";
...
WeatherServiceClient.prototype.getWeather = function getWeather(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(WeatherService.GetWeather, {
